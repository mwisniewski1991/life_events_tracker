...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 57, 20, 1779);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*delete_event*/ ctx[6](/*last_event_idd*/ ctx[4]))) /*delete_event*/ ctx[6](/*last_event_idd*/ ctx[4]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    ...
    // (55:16) {#if remove_button_disabled }
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 55, 20, 1631);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:16) {#if remove_button_disabled }",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*remove_button_disabled*/ ctx[3]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$3, 48, 16, 1322);
    			attr_dev(span, "class", "card-status svelte-gq4ckm");
    			add_location(span, file$3, 50, 16, 1382);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-outline-success svelte-gq4ckm");
    			add_location(button, file$3, 52, 16, 1456);
    			attr_dev(div0, "class", "card-button-container svelte-gq4ckm");
    			add_location(div0, file$3, 47, 8, 1270);
    			attr_dev(div1, "class", "card-body");
    			add_location(div1, file$3, 46, 4, 1238);
    			attr_dev(div2, "class", "card svelte-gq4ckm");
    			add_location(div2, file$3, 45, 0, 1215);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*post_event*/ ctx[5](/*action_idd*/ ctx[1]))) /*post_event*/ ctx[5](/*action_idd*/ ctx[1]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*action_status*/ 4) set_data_dev(t3, /*action_status*/ ctx[2]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	async function post_event(action_idd) {
    		...
    		if (response.ok) {
    			...
    			if (respond['posted'] == true) {
    				...
    				$$invalidate(3, remove_button_disabled = false);
    				$$invalidate(4, last_event_idd = respond['events_idd']);
    			}
    		} else {
    	...
    	async function delete_event(event_idd) {
    		if (last_event_idd != null) {
    			...
    			if (response.ok) {
    				$$invalidate(2, action_status = 'REMOVED');
    				$$invalidate(3, remove_button_disabled = true);
    			}
    		}
    	}
    	...
    	const writable_props = ['action_name', 'action_idd'];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('remove_button_disabled' in $$props) $$invalidate(3, remove_button_disabled = $$props.remove_button_disabled);
    		if ('last_event_idd' in $$props) $$invalidate(4, last_event_idd = $$props.last_event_idd);
    	};
    ...
    class ActionBox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { action_name: 0, action_idd: 1 });
    ...
    // (14:8) {#each actions_list as {action_idd, action_name}}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:8) {#each actions_list as {action_idd, action_name}}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 10, 8, 202);
    			attr_dev(div0, "class", "row");
    			add_location(div0, file$2, 9, 4, 176);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$2, 12, 4, 260);
    ...
    // (1:0) <script>  import ActionsCategoryBox from "./ActionsCategoryBox.svelte"; let promise = get_actions_list();  async function get_actions_list(){      const response = await fetch('/actions_list');      if (response.ok){         return response.json();     }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>  import ActionsCategoryBox from \\\"./ActionsCategoryBox.svelte\\\"; let promise = get_actions_list();  async function get_actions_list(){      const response = await fetch('/actions_list');      if (response.ok){         return response.json();     }",
    		ctx
    	});
    ...
    // (21:41)          {#each categories_list as {idd, name, actions_list}
    function create_then_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(21:41)          {#each categories_list as {idd, name, actions_list}",
    		ctx
    	});
    ...
    // (22:8) {#each categories_list as {idd, name, actions_list}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(22:8) {#each categories_list as {idd, name, actions_list}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			info.block.c();
    			attr_dev(div, "class", "actionContainer svelte-x5pas2");
    			add_location(div, file$1, 18, 0, 335);
    		},
    		l: function claim(nodes) {
